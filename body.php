  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item">
        <img src="img/banner4.jpg" alt="banner3" style="width:100%;">
				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=1"><div class="shop">
							...
							<div class="shop-body">
								<h3>Новое<br>поступление</h3>
								<a href="product.php?p=1" class="cta-btn">перейти <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div></a>
					</div>
					<!-- /shop -->
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=10"><div class="shop">
							...
							<div class="shop-body">
								<h3>Коллекция<br>верхней одежды</h3>
								<a href="product.php?p=10" class="cta-btn">перейти <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div></a>
					</div>
					<!-- /shop -->
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=79"><div class="shop">
							...
							<div class="shop-body">
								<h3>Трикотаж<br></h3>
								<a href="product.php?p=47" class="cta-btn">перейти <i class="fa fa-arrow-circle-right"></i></a>
							</div>
                            </div></a>
					</div>
					<!-- /shop -->
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="section-title">
							<h3 class="title">Новое поступление</h3>

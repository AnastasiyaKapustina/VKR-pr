	...
	if(mysqli_num_rows($run_query) > 0){
		...
		while($row = mysqli_fetch_array($run_query)){
			...
			echo "
                    ...
                    <div type='button' style='text-align: left' class='btn navbar-btn category'  cid='$cid'>
	...
	if(mysqli_num_rows($run_query) > 0){
		...
		while($row = mysqli_fetch_array($run_query)){
			...
			echo "
                    ...
                    <div type='button' style='text-align: left' class='btn navbar-btn selectBrand' bid='$bid'>
								...
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='product-body'>
										...
										<div class='product-btns'>
											<button class='add-to-wishlist'><i class='fa fa-heart-o'></i><span class='tooltipp'>В список желаемого</span></button>
									...
									<div class='add-to-cart'>
										<button pid='$pro_id' id='product' class='add-to-cart-btn block2-btn-towishlist' href='#'><i class='fa fa-shopping-cart'></i> В корзину</button>
									</div>
								</div>
							</div>
                        ...
                        <div class='col-md-4 col-xs-6'>
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='product-body'>
										...
										<div class='product-btns'>
											<button class='add-to-wishlist' tabindex='0'><i class='fa fa-heart-o'></i><span class='tooltipp'>в список желаемого</span></button>
											<button class='add-to-compare'><i class='fa fa-exchange'></i><span class='tooltipp'>сравнить</span></button>
											<button class='quick-view' ><i class='fa fa-eye'></i><span class='tooltipp'>быстрый просмотр</span></button>
										</div>
									</div>
									<div class='add-to-cart'>
										<button pid='$pro_id' id='product' href='#' tabindex='0' class='add-to-cart-btn'><i class='fa fa-shopping-cart'></i> в корзину</button>
									</div>
								</div>
							</div>
			";
	...
	if (isset($_POST["getCartItem"])) {
		...
		if (mysqli_num_rows($query) > 0) {
				...
				echo '
                    ...
                    <div class="product-widget">
												...
												<div class="product-body">
													...
													<h4 class="product-price"><span class="qty">'.$n.'</span>'.$product_price.' рублей</h4>
												</div>
            ...
            echo '<div class="cart-summary">
				    <small class="qty">'.$n.' товара(ов) выбрано</small>
					<small class="qty"> на сумму:</small>
				    <h5>'.$total_price.' рублей</h5>
				</div>'
            ?>
		...
		if (mysqli_num_rows($query) > 0) {
			...
			<form method="post" action="login_form.php">
	               ...
	               <table id="cart" class="table table-hover table-condensed" id="">
    				<thead>
						<tr>
							...
							<th style="width:7%" class="text-center">Сумма</th>
				...
				<tfoot>
					...
					<tr>
						<td><a href="store.php" class="btn btn-warning"><i class="fa fa-angle-left"></i> Назад в магазин</a></td>
				...
				if (!isset($_SESSION["uid"])) {
					echo '
							...
							<a href="" data-toggle="modal" data-target="#Modal_register" class="btn btn-success">Оплатить</a></td>
								</tr>
							</tfoot>
						...
						<form action="checkout.php" method="post">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/myfiles/public_html/payment_success.php"/>
									...
									<input type="submit" id="submit" name="login_user_with_product" name="submit" class="btn btn-success" value="Оплатить">
									</form></td>

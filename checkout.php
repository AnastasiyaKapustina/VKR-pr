			...
			<div class="col-75">
				...
				<form id="checkout_form" action="checkout_process.php" method="POST" class="was-validated">
					...
					<div class="col-50">
						...
						<input type="text" id="fname" class="form-control" name="firstname" pattern="^[а-яА-Я]+$"  value="'.$row["first_name"].' '.$row["last_name"].'">
						...
						<input type="text" id="city" name="city" class="form-control" value="'.$row["address2"].'" pattern="^[а-яА-Я]+$" required>

						<div class="row">
						<div class="col-50">
							<label for="state">Страна</label>
							<input type="text" id="state" name="state" class="form-control" pattern="^[а-яА-я]+$" required>
						</div>
						<div class="col-50">
					...
					<div class="col-50">
						...
						<input type="text" id="cname" name="cardname" class="form-control" pattern="^[а-яА-Я]+$" required>
						
						<div class="form-group" id="card-number-field">
                        <label for="cardNumber">Номер карты</label>
                        <input type="text" class="form-control" id="cardNumber" name="cardNumber" required>
                    </div>
						<label for="expdate">Срок действия карты</label>
					...
					<label><input type="CHECKBOX" name="q" class="roomselect" value="conform" required> Адрес доставки совпадает с адресом для выставления счета
					</label>';
					$i=1;
					$total=0;
				...
				<input type="hidden" name="total_count" value="'.$total_count.'">
					...
					<input type="submit" id="submit" value="Продолжить" class="checkout-btn">
				</form>
				</div>
			</div>
			';
			...
			<div class="col-25">
				...
				if (isset($_POST["cmd"])) {
					...
					while($i<=$total_count){
						...
						<tr><td><p>$item_number_</p></td><td><p>$item_name_</p></td><td ><p>$quantity_</p></td><td ><p>$amount_</p> руб</td></tr>";
				...
				<h3>ИТОГО<span class='price' style='color:black'><b>$total рублей</b></span></h3>";
				...
				<div class="row">
					<div class="col-md-12">
						<div class="newsletter">
							<p>Подпишитесь <strong>на обновления</strong></p>
							<form >

					...
					<ul class="header-links pull-right">
						<li><?php
                            ...
                            if(isset($_SESSION["uid"])){
                                ...
                                echo '
                               <div class="dropdownn">
                                  <a href="#" class="dropdownn" data-toggle="modal" data-target="#myModal" ><i class="fa fa-user-o"></i> Здравствуйте, '.$row["first_name"].'</a>
                                ...
                                echo '
                                <div class="dropdownn">
                                  <a href="#" class="dropdownn" data-toggle="modal" data-target="#myModal" ><i class="fa fa-user-o"></i> Личный кабинет</a>
                                  <div class="dropdownn-content">
			...
			<div id="header">
				...
				<div class="container">
					...
					<div class="row">
						...
						<!-- ACCOUNT -->
						<div class="col-md-9 clearfix" width:25% >
							<div class="header-ctn" width:25%>

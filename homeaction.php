...
if(isset($_POST["categoryhome"])){
	...
	echo "
				...
				<div id='responsive-nav'>
                    ...
                    <li><a href='store.php'>Костюмы</a></li>
	";
                       ...
                       <div class='product-widget'>
                                <a href='product.php?p=$pro_id'> 
									...
									<div class='product-body'>
										...
										<h4 class='product-price'>$pro_price<a class='product-old-price'> руб</a></h4>
									</div></a>
								</div>
			...
			echo "
								...
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='product-body'>
										...
										<h4 class='product-price header-cart-item-info'>$pro_price<a class='product-old-price'></a></h4>
